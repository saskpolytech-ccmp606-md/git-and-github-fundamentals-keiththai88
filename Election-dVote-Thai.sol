...
contract Election {
    ...
    function AaddCandidate(string memory _header, string memory _slogan)
        public
        // Only admin can add
        onlyAdmin
    {
    ...
    function CregisterAsVoter(string memory _name, string memory _phone) public {
    ...
    // Verify voter
    function DverifyVoter(bool _verifedStatus, address voterAddress)
        public
    ...
    // Vote
    function Evote(uint256 candidateId) public {
    ...
    // End election
    function FendElection() public onlyAdmin {
        end = true;
        start = false;
    }
